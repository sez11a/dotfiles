...
sudo pacman -S --noconfirm kaccounts-providers kio-gdrive kwalletmanager gst-libav gst-plugins-bad gst-plugins-ugly gst-python krusader kdesvn kdenlive audex krename choqok smb4k bibletime kcharselect kamoso latte-dock ktorrent digikam kleopatra arc-kde kvantum-theme-arc falkon unzip kio-gdrive flameshot
