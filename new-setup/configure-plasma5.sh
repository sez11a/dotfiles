...
yay -S --noconfirm  plasma5-applets-active-window-control-git plasma5-applets-window-appmenu plasma5-applets-window-buttons plasma5-applets-window-title plasma5-applets-playbar2 xfce-theme-greybird plasma5-applets-netspeed arc-kde-git
