...
# Editor
sudo dnf -qy install neovim xclipboard wl-clipboard jq yarn
...
# UI Fonts
sudo dnf -qy install texlive-libertinus texlive-libertinus-fonts texlive-libertinus-otf texlive-libertinus-type1 texlive-libertinust1math
